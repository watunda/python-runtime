...
class GenDockerfileTest(unittest.TestCase):
    ...
    def test_get_app_config(self):
        ...
        valid_cases = (
            # Basic app.yaml
            ('env: flex', False, {
                'base_runtime_image': 'prefixpythonsuffix',
    ...
    def test_generate_files(self):
        ...
        cases = (
            ...
            (base._replace(entrypoint='my entrypoint'), True,
             'CMD my entrypoint'),
            # Base runtime image
            (base._replace(base_runtime_image='my_base_runtime_image'), True,
        ...
        with tempfile.TemporaryDirectory(
            ...
            for app in ['hello_world']:
                ...
                args = argparse.Namespace(
                    ...
                    runtime_prefix='gcr.io/google_appengine/',
                    runtime_suffix='',
    ...
    def test_parse_args(self):
        valid_cases = (
            [],
            ['argv0', '--runtime-prefix=aprefix'],
            ['argv0', '--runtime-suffix=nocolon'],
            ['argv0', '--runtime-suffix=:withcolon'],
        )
        ...
        invalid_cases = (
            ['argv0', '--runtime-prefix=bad_:_colon'],
            ['argv0', '--runtime-suffix=bad_:_:_multiple_colons'],
        )
